...
s / 2
  ...
  main.variable(observer("globe")).define("globe", ["DOM","s","d3","radius","rotation","world","quakeColor","quakeRadius","quakes"], function(DOM,s,d3,radius,rotation,world,quakeColor,quakeRadius,quakes)
{
  ...
  main.variable(observer("viewof rotation")).define("viewof rotation", ["DOM"], function(DOM)
{
  ...
  main.variable(observer("viewof quakeSize")).define("viewof quakeSize", ["DOM"], function(DOM){return(
DOM.range(0, 12)
)});
  main.variable(observer("quakeSize")).define("quakeSize", ["Generators", "viewof quakeSize"], (G, _) => G.input(_));
  main.variable(observer("viewof quakeColor")).define("viewof quakeColor", ["DOM"], function(DOM)
{
  ...
  main.variable(observer("quakeRadius")).define("quakeRadius", ["d3","quakeSize"], function(d3,quakeSize)
{
